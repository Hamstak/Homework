	...
	// information is here:http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html#hashCode()
	/*
	 For example, 
	 You like to map each Employee(Key) to their Address(Value), in your Employee implementation 
